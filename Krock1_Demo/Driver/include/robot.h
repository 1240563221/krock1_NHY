...
public:
    ...
    Robot(int num_Motors, int baudrate, const int *ID_numbers, const char *portName);
    ~Robot();
    ...
    void setAllPositions(double *angles, const int *ids);
    void setAllCurrents(double *currents, const int *ids);
    void getAllPositions(double *angles, const int *ids);
    void getAllCurrents(double *currents, const int *ids);
    ...
    void SetInitialPosture(const int *ids);
