...
private:
    ...
    dynamixel::GroupSyncRead *groupSyncRead_current_velocity_position;
...
public:
    ...
    void getAllCurrentsVelocityPosition(double *currents, double *velocity, double *position, int *ids);
